...
#packages="apache php56-apache php56-gd php56 mariadb dhcp tftp-hpa nfs-utils vsftpd net-tools wget xinetd tar gzip make m4 gcc htmldoc perl perl-crypt-passwdmd5 lftp";
packages="apache php56-fpm php56-gd php56 mariadb dhcp tftp-hpa nfs-utils vsftpd net-tools wget xinetd tar gzip make m4 gcc perl perl-crypt-passwdmd5 lftp";
storageNodePackages="apache php56-fpm php56 mariadb nfs-utils vsftpd xinetd tar gzip make m4 gcc gcc-c++ lftp";
